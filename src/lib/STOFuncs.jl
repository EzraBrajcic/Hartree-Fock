...
function CoulombInt(a::STO, b::STO, c::STO, d::STO)
    # Represents the integral (ab|cd) = ∫∫φ†_a(r1)φ_b(r1)1/|r1-r2|φ†_c(r2)φ_d(r2) dr1dr2 (also represented as <φ_a φ_b|1/|r1-r2||φ_c φ_d>) such that the radial coordinates follow the form of (12|12)
    result::Float64 = 0.0
    ...
    for L in L_min:L_max
        ...
        for M in -L:L
            ...
            elseif ((c.m == a.m + M) && (d.m + M == b.m))
                ...
                M_Sum += GauntPrefactor * ac_GauntCoefficient * bd_GauntCoefficient
            else
                M_Sum += 0.0
            end
